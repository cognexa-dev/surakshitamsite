import { A as AstroError, j as UnsupportedImageFormat, i as MissingSharp } from './entrypoint_CPbSosTj.mjs';
import { b as baseService, d as detector, p as parseQuality } from './generic_DCnqzkeL.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_CBWnyuRg.mjs').then(n => n.i)).default;
  } catch {
